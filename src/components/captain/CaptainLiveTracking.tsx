...
const CaptainLiveTracking: FC<{ drop: any, pickup: any, captain: any; status: string }> = ({ status, drop, pickup, captain }) => {
    ...
    useEffect(() => {
        if (pickup?.latitude && drop?.latitude) fitToMarkersWithDelay();
